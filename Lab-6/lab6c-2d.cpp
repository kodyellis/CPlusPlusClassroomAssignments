...
int main()
{
	...
	cout << "The movie type is: " << movie_type << endl
	<< "The amount of movies is: " << movie_count << endl 
	<< "The amount of money the last person spent on movies is: " << movie_spending_amount << endl 
	<< "The number of students who spent over $75 on movies is:" << percent_students << endl 
	<< "The amount of people who also got dvds are: " << dvd_people << endl 
	<< "The total movie amount is: " << total_movie_count << endl 
	<< "The number of people who bought a movie is: " << num_people << endl 
	<< "The average number of movies people have is: " << avg_movies << endl 
	<< "The percent of students who spent over $75 on movies is:" << "%"
	<< total_percent_students << endl;
